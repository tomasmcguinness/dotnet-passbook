...
namespace Passbook.Web
{
	public abstract class PassProvider : IDisposable
	{
        ...
        /// </summary>
        /// <returns><c>true</c>, if pass type is supportsed, <c>false</c> otherwise.</returns>
		...
		public virtual PassGeneratorRequest GetPass(string passTypeIdentifier, string serialNumber)
		{
			throw new NotImplementedException();
		}
